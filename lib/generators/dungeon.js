...
Dungeon = (function() {
  ...
  function Dungeon(map_width, map_height, max_features, room_chance) {
    var counting_tries, dir, east_tile, feature, newx, newy, north_tile, south_tile, state, testing, valid_tile, ways, west_tile, x, xmod, y, ymod;
    ...
    while (state !== 10) {
      ...
      while (testing < 1000) {
        ...
        if (state === 0 && ways === 0) {
          ...
          state = 1;
          break;
        } else if (state === 1 && ways === 0 && this.distance(this.up_stairs_pos.x, this.up_stairs_pos.y, newx, newy) > 10) {
