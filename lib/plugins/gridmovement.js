    ...
    .defines(function () {
        GridMovement = ig.Class.extend({
            ...
            startMoving:function (direction) {
                ...
                // Move.
                this.setVelocityByTile(this.destination.x, this.destination.y, this.entity.gridSpeed);
            },
            ...
            setVelocityByTile:function (tileX, tileY) {
                ...
                this.entity.vel.x = this.entity.vel.y = 0;
                if (entityCenterX > tileCenterX) this.entity.vel.x = -this.entity.gridSpeed.x;
                else if (entityCenterX < tileCenterX) this.entity.vel.x = this.entity.gridSpeed.x;
                else if (entityCenterY > tileCenterY) this.entity.vel.y = -this.entity.gridSpeed.y;
                else if (entityCenterY < tileCenterY) this.entity.vel.y = this.entity.gridSpeed.y;
            }
