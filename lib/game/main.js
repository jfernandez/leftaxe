...
LeftAxe = ig.Game.extend({
	...
	draw: function() {
		...
		if(this.player) {
			...
			//Compute visibility
			this.fov.compute(posX, posY, 5, _.bind(this.fovCallback, this));
	...
	drawHealth: function() {
		this.console.drawText(1,  1, 'HP: ' + this.player.health + '/' + this.player.maxHealth);
	},

	drawExperience: function() {
		this.console.drawText(1, 2, 'XP: ' + this.player.experience);
	},
...
ig.main( '#canvas', LeftAxe, 60, 320, 262, 2);
